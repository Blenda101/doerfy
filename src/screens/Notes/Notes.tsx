...
import { Note, NoteWithAuthor, Notebook } from '../../types/note';
import { Theme, getInitialTheme } from '../../utils/theme';
import { supabase } from '../../utils/supabaseClient';
import { cn } from '../../lib/utils';
import { StickyNote, Search, Plus, MoreHorizontal, Trash2, Lock } from 'lucide-react';
    ...
    <div className={cn(
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex-1 flex overflow-hidden">
          <div className="w-80 border-r flex flex-col overflow-hidden dark:border-slate-700">
            <div className="p-4">
                  ...
                  {filteredNotes.map((note) => (
                    <div
                      ...
                      className={cn(
                        ...
                        selectedNote?.id === note.id && "bg-gray-50 dark:bg-slate-700",
