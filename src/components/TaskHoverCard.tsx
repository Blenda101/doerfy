...
export const TaskHoverCard: React.FC<TaskHoverCardProps> = ({
  task,
  children,
}) => {
  ...
  return (
    <HoverCard.Root openDelay={200} closeDelay={300}>
      ...
      <HoverCard.Portal>
        <HoverCard.Content
          className={cn(
            "rounded-lg shadow-lg p-4 w-64 animate-in fade-in-0 zoom-in-95 z-50",
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex justify-between items-center w-full">
                ...
                <span className="text-sm font-medium text-gray-900 dark:text-gray-100">
                  {task.schedule?.date
                    ? format(new Date(task.schedule.date), "MMM d, yyyy")
                    : "None"}
                </span>
              </div>
            </div>
