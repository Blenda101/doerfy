  ...
  const InfoIcon = ({ tooltip }: { tooltip: string }) => (
    <Tooltip>
      <TooltipTrigger asChild>
        <HelpCircle className="w-4 h-4 ml-2 text-gray-400 hover:text-gray-600 dark:text-gray-500 dark:hover:text-gray-400 cursor-help" />
      </TooltipTrigger>
      <TooltipContent>
        <p>{tooltip}</p>
      </TooltipContent>
        ...
        <DialogContent className={cn(
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <div className="flex items-center gap-2">
                    <Bell className={cn(
                      "w-5 h-5",
                      !currentSchedule.time ? "text-gray-300" : 
                      currentSchedule.alarmEnabled ? "text-purple-500" : "text-gray-400"
                    )} />
                    <Switch
          ...
          <div className="mt-4">
            ...
            >
              <div>
                <div className="flex items-center mb-2">
                  <Label className="dark:text-slate-200">Lead Days</Label>
                  {isLeadHovered && (
              ...
              <div>
                <div className="flex items-center mb-2">
                  <Label className="dark:text-slate-200">Lead Hours</Label>
                  {isLeadHovered && (
            ...
            >
              <div>
                <div className="flex items-center mb-2">
                  <Label className="dark:text-slate-200">Duration Days</Label>
                  {isDurationHovered && (
              ...
              <div>
                <div className="flex items-center mb-2">
                  <Label className="dark:text-slate-200">Duration Hours</Label>
                  {isDurationHovered && (
                    ...
                    <div className="flex space-x-2">
                      {['S', 'M', 'T', 'W', 'T', 'F', 'S'].map((day, index) => (
                        <Button
                          ...
                          onClick={() => {
                            const weekDays = currentSchedule.recurring?.weekDays || [];
