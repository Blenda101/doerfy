...
export const PropertySheet: React.FC<PropertySheetProps> = ({
  ...
  return (
    <div
      className={cn(
        "min-w-[500px] h-screen flex flex-col",
    ...
    >
      ...
      >
        <InfoIcon
          className={theme === "dark" ? "text-[#8B5CF6]" : "text-[#5036b0]"}
        />
        <h2
          className={cn(
      ...
      <div className="sticky top-0 p-4 bg-inherit z-50">
        <input
          type="text"
          className={cn(
          ...
          <div className="flex justify-between items-center mb-6">
            <div className="flex items-center gap-4">
              ...
              <EditableProperty
                label=""
                value={
                  task.timeStage.charAt(0).toUpperCase() +
                  task.timeStage.slice(1)
                }
